    ...
    <section className="section-shell section-shell--cta text-[var(--color-ink)]">
      <div className="mx-auto max-w-5xl px-6 py-20 text-center lg:px-10 lg:py-24">
        ...
        <GsapReveal delay={0.42} y={18}>
          <a
            className="mt-10 inline-flex min-h-14 items-center justify-center rounded-full bg-[rgba(88,117,101,0.96)] px-8 text-sm font-semibold uppercase tracking-[0.16em] text-[var(--color-surface)] shadow-[0_10px_24px_rgba(36,29,26,0.14),inset_0_1px_0_rgba(255,253,248,0.12)] transition-[transform,box-shadow,background-color] duration-300 ease-out hover:-translate-y-[2px] hover:bg-[rgba(82,110,94,1)] hover:shadow-[0_14px_26px_rgba(36,29,26,0.16)] focus-visible:-translate-y-[2px] focus-visible:shadow-[0_14px_26px_rgba(36,29,26,0.16)] motion-reduce:transform-none motion-reduce:transition-none"
